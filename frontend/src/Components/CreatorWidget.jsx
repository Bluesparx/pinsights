        ...
        >
            ...
            <span
                className={`
                    ...
                    bg-mustard ring-4 ring-white shadow-warm-lg
            ...
            >
                ...
                />
                <span className="absolute -top-1 -right-1 w-5 h-5 rounded-full bg-candy-coral text-white flex items-center justify-center ring-2 ring-white">
